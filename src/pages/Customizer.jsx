...
const Customizer = ({ setShowKonva }) => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const keyResponse = await axios.get(
        "https://custom-art-system-server.onrender.com/api/razorpay-key"
      );
      ...
      const orderResponse = await axios.post(
        "https://custom-art-system-server.onrender.com/api/orders",
        { amount }
      );
      const {
        id: order_id,
        ...
        handler: async (response) => {
          ...
          try {
            const captureResponse = await axios.post(
              `https://custom-art-system-server.onrender.com/api/capture/${paymentId}`,
              {
                amount,
                image: image,
  ...
  const handleSubmit = async (type) => {
    ...
    try {
      ...
      const response = await fetch("https://custom-art-system-server.onrender.com/api/v1/dalle", {
        method: "POST",
        headers: {
